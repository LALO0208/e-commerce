        ...
        <div class="row list-1" style="display: none">
            <div class="media border-bottom px-3 pt-4 pb-3 pb-lg-2">
                ...
                <div class="media-body ps-3">
                    <h5><small class="text-uppercase text-muted">Collar de Diamantes</small></h5>
                    <span class="badge badgenew bg-warning text-uppercase text-white pt-2">Nuevo</span>
                    <p class="my-2">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Saepe nulla tenetur earum? Deleniti
                        id molestiae illum, obcaecati maxime repudiandae laboriosam autem repellendus voluptatem rem, sapiente nam cupiditate reprehenderit culpa sit?</p>
                    <div class="clearfix">
                        <h5 class="float-start text-uppercase text-muted"><small>Gratis</small></h5>
                        <span class="float-end">
                            <div class="btn-group btn-group-sm">
