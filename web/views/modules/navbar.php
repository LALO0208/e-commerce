          ...
          <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
            ...
            <li class="dropdown-submenu dropdown-hover">
              <a id="dropdownSubMenu2" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-item dropdown-toggle text-uppercase">
                <i class="fas fa-tshirt pe-2 fa-xs"></i>
                Ropa
              </a>
              <ul class="border-0 shadow py-3 ps-3 d-block d-lg-none">
                ...
                <li>
                  <a tabindex="-1" href="#" class="dropdown-item">Ropa para hombres</a>
                </li>
                <li>
            ...
            <li class="dropdown-submenu dropdown-hover">
              <a id="dropdownSubMenu2" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-item dropdown-toggle text-uppercase">
                <i class="fas fa-shoe-prints pe-2 fa-xs"></i>
                Calzado
              </a>
              <ul class="border-0 shadow py-3 ps-3 d-block d-lg-none">
                <li>
                ...
                <li>
                  <a tabindex="-1" href="#" class="dropdown-item">Calzado para hombres</a>
                </li>
                <li>
            ...
            <li class="dropdown-submenu dropdown-hover">
              <a id="dropdownSubMenu2" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-item dropdown-toggle text-uppercase">
                <i class="fas fa-laptop pe-2 fa-xs"></i>
                Tecnología
              </a>
              <ul class="border-0 shadow py-3 ps-3 d-block d-lg-none">
                <li>
            ...
            <li class="dropdown-submenu dropdown-hover">
              <a id="dropdownSubMenu2" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-item dropdown-toggle text-uppercase">
                <i class="fas fa-graduation-cap pe-2 fa-xs"></i>
                Cursos
              </a>
              <ul class="border-0 shadow py-3 ps-3 d-block d-lg-none">
                <li>
                ...
                <li>
                  <a tabindex="-1" href="#" class="dropdown-item">Diseño grafico</a>
                </li>
                <li>
      ...
      <div class="col-12 col-lg-3 col-xl-2 mt-1 px-3 px-lg-0">
        <div class="my-2 my-lg-0 d-flex justify-content-center">
          ...
          <div class="small border float-start ps-2 pe-5 w-100">
            TU CARRITO<span>0</span><br>USD $ <span>0</span>
          </div>
        </div>
      </div>
    </div>
