  ...
  <div class=" container py-5 text-light">
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3">
      ...
      <div class="col my-3 my-lg-0 px-lg-5 text-light">
        <h1 class="lead small">
          Dudas e inquitudes, contactenos en:
        </h1>
        <br>
        <h1 class="lead small">
          <i class="fa fa-phone-square pe-2"></i>(555) 555-55-55
          <br><br>
          <i class="fa fa-envelope pe-2"></i> soporteTI@tiendavirtual.com
          <br><br>
          <i class="fa fa-map-marker pe-2"></i> pichucalco, no. 45 ext
          <br><br>
          chiapas
        </h1>
      ...
      <div class="col small my-3 my-lg-0">
        ...
        <form action="">
          ...
          <br>
          <input type="email" id="emailContactenos" name="emailContactenos" class="form-control" placeholder="Email" required>
          <br>
          <textarea name="mensajeContactenos" name="mensajeContactenos" class="form-control" placeholder="
          Escriba su mensaje" rows="5" required></textarea>
          <br>
  ...
  <div class="container">
    ...
    <div class="float-end">
      <div class="d-flex justify-content-center" style="line-height: 0px;">
        ...
        <div class="p-2">
          <a href="https://www.x.com/" target="_blank" class="text-white">
    ...
    <!-- Default to the left -->
    <strong>&copy; <?php echo date("Y") ?> <small> Todos los derechos reservados. Sitio elaborado por la compañía</small>
  </div>
</footer>